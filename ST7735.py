...
class TFT(object) :
  ...
  WHITE = 0
  YELLOW = TFTColor(0xFF, 0x00, 0x00)
  MAROON = TFTColor(0x80, 0x00, 0x00)
  PURPLE = TFTColor(0x00, 0xFF, 0x00)
  FOREST = TFTColor(0x00, 0x80, 0x80)
  CYAN = TFTColor(0x00, 0x00, 0xFF)
  NAVY = TFTColor(0x00, 0x00, 0x80)
  BLUE = TFTColor(0x00, 0xFF, 0xFF)
  RED = TFTColor(0xFF, 0xFF, 0x00)
  GREEN = TFTColor(0xFF, 0x00, 0xFF)
  BLACK = TFTColor(0xFF, 0xFF, 0xFF)
